...
9. On the **Add data source** template, under **Data source type**, select **Windows Event Logs**. In the **Configure the event logs and levels to collect** section, choose the following settings, then select Next: Destination >.
